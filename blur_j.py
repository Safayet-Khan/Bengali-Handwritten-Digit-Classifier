# -*- coding: utf-8 -*-
"""
Created on Tue Dec  1 12:03:35 2020
...
SAVE_INFO = ['training-j', 'training-j-blur.csv']
...
for img_array in range(0, NUM_NEW_IMAGE):
    name_label_row = []
    FILE_NAME = 'j{:05d}.jpg'.format(COUNTER)
    ...
    ksize = np.random.randint(5, 12)
    noisy_image = cv2.blur(x_array[image_index], (ksize, ksize))
